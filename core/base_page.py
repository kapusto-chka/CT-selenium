...
# custom methods
    ...
    def wait_until_visible(self, *locators, wait=3):
        """
        Wait in seconds until element is visible
        :param *locators: str - list of xpath for elements
        :param wait: int - wait time in seconds
        """
        try:
            for locator in locators:
                self.is_visible(locator, wait)
        except TimeoutException as ex:
            print("Failed to locate element with xpath: {}".format(locator))
            raise ex
